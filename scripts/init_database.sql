...
IF EXISTS (SELECT * FROM sys.databases WHERE name = N'BankChurnAnalytics')
BEGIN
    ALTER DATABASE BankChurnAnalytics SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE BankChurnAnalytics;
END
GO

CREATE DATABASE BankChurnAnalytics;
GO
